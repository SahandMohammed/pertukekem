...
class _CustomerOrdersContent extends StatelessWidget {
  ...
  Widget _buildOrderStats(CustomerOrdersViewModel viewModel) {
    return Container(
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildStatCard(
                  'Delivered',
                  viewModel.deliveredOrders.toString(),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildStatCard(
                  'Total Spent',
                  'Ksh ${NumberFormat('#,##0.00').format(viewModel.totalSpent)}',
